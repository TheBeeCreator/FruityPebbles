...
public class FPItemModels extends ItemModelProvider {

    public FPItemModels(DataGenerator generator, ExistingFileHelper existingFileHelper) {
        super(generator, fruitypebblemod.MODID, existingFileHelper);
    }
